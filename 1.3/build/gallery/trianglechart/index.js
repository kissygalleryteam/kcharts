...
gallery/kcharts/1.3/gallery/trianglechart/theme
gallery/kcharts/1.3/gallery/trianglechart/index

*/
KISSY.add("gallery/kcharts/1.3/gallery/trianglechart/theme",function(S){
...
KISSY.add('gallery/kcharts/1.3/gallery/trianglechart/index', function(S, Template, BaseChart,Theme,Raphael, Color, HtmlPaper, Legend, undefined, Tip) {
	var $ = S.all,
		Evt = S.Event,
		win = window,
		clsPrefix = "ks-chart-",
