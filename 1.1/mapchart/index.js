              ...
              S.augment(MapChart, S.Event.Target, {
                  ...
                  proceedSeries:function () {
                      ...
                      S.each(self.series, function (item, index) {
                          var pro = MapData.mapDataSource[index];
                  ...
                  drawPath:function (paths) {
                      ...
                      function over(ev) {
                          ...
                          cb && cb.over && self.series[index] && cb.over([index, self.series[index].areaName]);
                      }
                      ...
                      function move(ev) {
                          ...
                          cb && cb.move && cb.move([index, self.series[index].areaName]);
                      ...
                      function out(ev) {
                          var index = this.index;
                          self.isInPaper = false;
                          cb && cb.out && cb.out([index, self.series[index].areaName]);
