...
kg/kcharts/6.0.0/barchart/cfg
kg/kcharts/6.0.0/barchart/index
...
;KISSY.add('kg/kcharts/6.0.0/barchart/cfg',function(S){
 ...
 */
;
KISSY.add('kg/kcharts/6.0.0/barchart/index',function(S, Node, Base, Template, BaseChart, Raphael, Color, HtmlPaper, Legend, Theme, Touch, Tip, Evt, Cfg) {
	var $ = S.all,
		clsPrefix = "ks-chart-",
		themeCls = clsPrefix + "default",
