...
kg/kcharts/6.0.0/realtime/index

*/
;KISSY.add('kg/kcharts/6.0.0/realtime/index',function(S,Raphael,Base,Promise,Anim,Util,D,E,ColorLib){
   //==================== STATIC start ====================
   var COLOR_TPL = "{COLOR}";
   //==================== STATIC end ====================
   ...
   * */
   ...
   var props = {
     ...
     renderTip:function(tipconfig){
       ...
       S.use("kg/kcharts/6.0.0/tip/index,kg/kcharts/6.0.0/tip/assets/tip.css",function(S,Tip){
         var bbox = that.getBBox();
         // 修正bbox字段
         bbox.x = bbox.left;
         bbox.y = bbox.top;
   ...
   requires:["kg/kcharts/6.0.0/raphael/index","base","promise","kg/kcharts/6.0.0/animate/index","kg/kcharts/6.0.0/realtime/util","dom","event","kg/kcharts/6.0.0/tools/color/index"]
 });
