...
kg/kcharts/6.0.0/basechart/common
kg/kcharts/6.0.0/basechart/index

*/
KISSY.add('kg/kcharts/6.0.0/basechart/common',function(S, Template) {
...
*/
;
KISSY.add('kg/kcharts/6.0.0/basechart/index',function(S, Base, Node, Common) {
	var $ = S.all;
