...
kg/kcharts/6.0.0/piechart/util
kg/kcharts/6.0.0/piechart/sector
kg/kcharts/6.0.0/piechart/label
kg/kcharts/6.0.0/piechart/index
 ...
 * sector数据处理
 * */
;KISSY.add('kg/kcharts/6.0.0/piechart/util',function(S,Sector,Color,Raphael){
...
// -*- coding: utf-8; -*-
;KISSY.add('kg/kcharts/6.0.0/piechart/sector',function(S,Base){
  // 顺时针的sector
...
// -*- coding: utf-8; -*-
;KISSY.add('kg/kcharts/6.0.0/piechart/label',function(S,Node,Base,D){
   // helpers
...
// -*- coding: utf-8; -*-
;KISSY.add('kg/kcharts/6.0.0/piechart/index',function(S,Util,Sector,Animate,Labels,Raphael,Color,Base,E,D){
   var COLOR_TPL = "{COLOR}";
   function render(){
     this.destroy();
   ...
   var methods = {
     ...
     onafterrender:function(){
       ...
       if(config){
         ...
         S.use("kg/kcharts/6.0.0/legend/index",function(S,Legend){
     ...
     renderTip:function(tipconfig){
       ...
       S.use("kg/kcharts/6.0.0/tip/index",function(S,Tip){
