 ...
 * sector数据处理
 * */
;KISSY.add('kg/kcharts/2.0.0/piechart/util',function(S,Sector,Color,Raphael){
...
// -*- coding: utf-8; -*-
;KISSY.add('kg/kcharts/2.0.0/piechart/index',function(S,Util,Sector,Animate,Labels,Raphael,Color,Base,E,D){
   var COLOR_TPL = "{COLOR}";
   function render(){
     this.destroy();
