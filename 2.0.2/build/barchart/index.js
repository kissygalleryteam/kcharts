...
kg/kcharts/2.0.1/barchart/theme
kg/kcharts/2.0.1/barchart/cfg
kg/kcharts/2.0.1/barchart/index

*/
;KISSY.add('kg/kcharts/2.0.1/barchart/theme',function(S){
 ...
 */
;
KISSY.add('kg/kcharts/2.0.1/barchart/index',function(S, Node, Base, Template, BaseChart, Raphael, Color, HtmlPaper, Legend, Theme, Touch, Tip, Evt, Cfg) {
	var $ = S.all,
		clsPrefix = "ks-chart-",
		themeCls = clsPrefix + "default",
