...
kg/kcharts/2.0.1/datetime/cfg
kg/kcharts/2.0.1/datetime/index
...
;KISSY.add('kg/kcharts/2.0.1/datetime/cfg',function(S){
 ...
 */
;
KISSY.add('kg/kcharts/2.0.1/datetime/index',function(S, D, Evt, Node, Base, Template, LineChart, Raphael, BaseChart, ColorLib, HtmlPaper, Legend, Theme, Touch, Tip, Anim, graphTool, Cfg) {
	var $ = S.all,
		clsPrefix = "ks-chart-",
		themeCls = clsPrefix + "default",
