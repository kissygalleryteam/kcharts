...
kg/kcharts/6.0.1/realtime/index

*/
;KISSY.add('kg/kcharts/6.0.1/realtime/index',function(S,Raphael,Base,Promise,Anim,Util,D,E,ColorLib){
   //==================== STATIC start ====================
   var COLOR_TPL = "{COLOR}";
   //==================== STATIC end ====================
   ...
   * */
   ...
   var props = {
     ...
     renderTip:function(tipconfig){
       ...
       S.use("kg/kcharts/6.0.1/tip/index,kg/kcharts/6.0.1/tip/assets/tip.css",function(S,Tip){
         var bbox = that.getBBox();
         // 修正bbox字段
         bbox.x = bbox.left;
         bbox.y = bbox.top;
   ...
   requires:["kg/kcharts/6.0.1/raphael/index","base","promise","kg/kcharts/6.0.1/animate/index","kg/kcharts/6.0.1/realtime/util","dom","event","kg/kcharts/6.0.1/tools/color/index"]
 });
