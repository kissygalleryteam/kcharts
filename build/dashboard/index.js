...
kg/kcharts/6.0.0/dashboard/pointer
kg/kcharts/6.0.0/dashboard/pointer-pic
kg/kcharts/6.0.0/dashboard/dashboard-ticks
kg/kcharts/6.0.0/dashboard/index
 ...
 * */
;KISSY.add('kg/kcharts/6.0.0/dashboard/pointer',function(S,Base){
   var methods = {
 ...
 * @author cookieu@gmail.com
 * */
;KISSY.add('kg/kcharts/6.0.0/dashboard/pointer-pic',function(S,Pointer){
 ...
 * @author cookieu@gmail.com
 * */
;KISSY.add('kg/kcharts/6.0.0/dashboard/dashboard-ticks',function(S,Base){
   var methods = {
 ...
 * @author cookieu@gmail.com
 */
;KISSY.add('kg/kcharts/6.0.0/dashboard/index',function(S,Raphael,Pointer,PicturePointer,Ticks,Base,D,E){
