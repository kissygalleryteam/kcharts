...
kg/kcharts/6.0.0/linechart/theme
kg/kcharts/6.0.0/linechart/cfg
kg/kcharts/6.0.0/linechart/index

*/
;KISSY.add('kg/kcharts/6.0.0/linechart/theme',function(S){
...
;KISSY.add('kg/kcharts/6.0.0/linechart/cfg',function(S){
 ...
 */
;
KISSY.add('kg/kcharts/6.0.0/linechart/index',function(S, Base, Node, D, Evt, Template, Raphael, BaseChart, ColorLib, HtmlPaper, Legend, Theme, Touch, Tip, Anim, graphTool, Cfg) {
	var $ = S.all,
		clsPrefix = "ks-chart-",
		themeCls = clsPrefix + "default",
