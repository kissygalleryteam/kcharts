...
kg/kcharts/6.0.1/piechart/util
kg/kcharts/6.0.1/piechart/sector
kg/kcharts/6.0.1/piechart/label
kg/kcharts/6.0.1/piechart/index
 ...
 * sector数据处理
 * */
;KISSY.add('kg/kcharts/6.0.1/piechart/util',function(S,Sector,Color,Raphael){
  ...
  requires:["kg/kcharts/6.0.1/piechart/sector","kg/kcharts/6.0.1/tools/color/index","kg/kcharts/6.0.1/raphael/index"]
});
...
// -*- coding: utf-8; -*-
;KISSY.add('kg/kcharts/6.0.1/piechart/label',function(S,Node,Base,D){
   // helpers
...
// -*- coding: utf-8; -*-
;KISSY.add('kg/kcharts/6.0.1/piechart/index',function(S,Util,Sector,Animate,Labels,Raphael,Color,Base,E,D){
   var COLOR_TPL = "{COLOR}";
   function render(){
     this.destroy();
   ...
   var methods = {
     ...
     onafterrender:function(){
       ...
       if(config){
         ...
         S.use("kg/kcharts/6.0.1/legend/index",function(S,Legend){
     ...
     renderTip:function(tipconfig){
       ...
       S.use("kg/kcharts/6.0.1/tip/index",function(S,Tip){
