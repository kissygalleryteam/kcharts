...
kg/kcharts/6.0.1/linechart/theme
kg/kcharts/6.0.1/linechart/cfg
kg/kcharts/6.0.1/linechart/index

*/
;KISSY.add('kg/kcharts/6.0.1/linechart/theme',function(S){
...
;KISSY.add('kg/kcharts/6.0.1/linechart/cfg',function(S){
 ...
 */
;
KISSY.add('kg/kcharts/6.0.1/linechart/index',function(S, Base, Node, D, Evt, Template, Raphael, BaseChart, ColorLib, HtmlPaper, Legend, Theme, Touch, Tip, Anim, graphTool, Cfg) {
	var $ = S.all,
		clsPrefix = "ks-chart-",
		themeCls = clsPrefix + "default",
