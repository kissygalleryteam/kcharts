...
kg/kcharts/6.0.1/dashboard/pointer
kg/kcharts/6.0.1/dashboard/pointer-pic
kg/kcharts/6.0.1/dashboard/dashboard-ticks
kg/kcharts/6.0.1/dashboard/index

*/
;KISSY.add('kg/kcharts/6.0.1/raphael/index',function(S){
 ...
 * */
;KISSY.add('kg/kcharts/6.0.1/dashboard/pointer',function(S,Base){
   var methods = {
 ...
 * @author cookieu@gmail.com
 * */
;KISSY.add('kg/kcharts/6.0.1/dashboard/pointer-pic',function(S,Pointer){
 ...
 * @author cookieu@gmail.com
 */
;KISSY.add('kg/kcharts/6.0.1/dashboard/index',function(S,Raphael,Pointer,PicturePointer,Ticks,Base,D,E){
